...
public class Menu {
        ...
        do {
            ...
            switch (menu1) {
                ...
                case 6:
                    subWhileMenu();break;
                case 7:
                    subDoWhileMenu();break;
                case 8:
                    subBreakMenu();break;
                case 9:
                    subContinueMenu();break;
                case 10:
                    subStaticMethodMenu();break;
                case 11:
                    subNonStaticMethodMenu();break;
                case 12:
                    ...
                    break;
                default:
                    System.out.println("잘못된 값을 입력하였습니다. 다시 입력해주세요.");break;
            }
        } while (true);
    }
    ...
    public void subPTypeMenu(){
        ...
        do {
            ...
            switch(menu1) {
                ...
                case 2: System.out.println("메인 메뉴로 돌아갑니다.");return;
    ...
    public void subDoWhileMenu(){
        ...
        do {
            ...
            switch (mn) {
                case 1:
                    dws.addDashToken();break;
                case 2:
                    dws.burgerKingMenu();break;
                case 3:
                    dws.isStringAlphabet();break;
                case 4:
                    System.out.println("메인 메뉴로 돌아갑니다.");return;
                default:
                    System.out.println("잘못된 값을 입력하였습니다. 다시 입력해주세요.");break;
    ...
    public void subStaticMethodMenu(){
        ...
        do {
            ...
            switch(menu1) {
                case 1:
                    sms.testMathRandom();break;
                case 2:
                    sms.testMathAbs();break;
                case 3:
                    sms.testMathMax();break;
                case 4:
                    System.out.println("메인 메뉴로 돌아갑니다.");return;
                default:
                    System.out.println("잘못된 값을 입력하였습니다. 다시 입력하세요.");
    ...
    public void subNonStaticMethodMenu(){
        ...
        do {
            ...
            switch(menu1) {
                case 1:
                    nsms.testScanner();break;
                case 2:
                    nsms.testRandom();break;
                case 3:
                    System.out.println("메인 메뉴로 돌아갑니다.");return;
                default:
                    System.out.println("잘못된 값을 입력하였습니다. 다시 입력하세요.");
